...
import { clearUserData, UserState } from "@/redux/slices/userSlice";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
    ...
    return (
        <aside
            ref={sidebar}
            className={`bg-white absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden duration-300 ease-linear lg:static lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
                }`}
        >

            <div className="flex items-center justify-between gap-2 px-6 py-8">
                <Text color="dark-green" variant="title1" additional="w-full text-center mt-8">
                    Logo
                </Text>
                <button
                    ref={trigger}
                    ...
                    <div>
                        <ul className="mb-6 flex flex-col gap-1.5">
                            <li>
                                <Link
                                    href="/dashboard/home"
                                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === '/dashboard/home' ? 'text-green-700' : 'hover:text-green-300'}`}
                                >
                                    <svg
                                        className="fill-current"
                                        width="18"
                            ...
                            <li>
                                <Link
                                    ...
                                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === '/dashboard/stats' ? 'text-green-700' : 'hover:text-green-300'}`}
                                >
                                    <svg
                                        className="fill-current"
                                        width="18"
                            ...
                            <li>
                                <Link
                                    ...
                                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === '/dashboard/profile' ? 'text-green-700' : 'hover:text-green-300'}`}
                                >
                                    <svg
                                        className="fill-current"
                                        width="18"
                            ...
                            <div
                                className='rounded-xl bg-red-600 text-white text-center font-semibold px-4 py-2 cursor-pointer hover:bg-red-400'
